  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex md:grid md:grid-cols-3 gap-4 overflow-x-auto pb-4 md:pb-0 snap-x snap-mandatory no-scrollbar -mx-4 px-4 md:mx-0 md:px-0">
        ...
        {/* Card Saldo */}
        <div className="min-w-[85%] md:min-w-0 snap-center bg-gradient-to-br from-purple-900/80 to-[#1f1630] p-6 rounded-3xl border border-white/10 shadow-xl relative overflow-hidden group">
        ...
        {/* Card Entradas */}
        <div className="min-w-[45%] md:min-w-0 snap-center bg-[#1f1630] p-5 rounded-3xl border border-white/5 shadow-lg flex flex-col justify-between group">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        {/* Gráfico de Pizza */}
        <div className="bg-[#1f1630] p-6 rounded-3xl border border-white/5 shadow-lg flex flex-col min-h-[300px]">
